...
// WiFi Configuration
// Prefer local, untracked secrets if available; otherwise use placeholders or -D defines.
...
#ifndef WIFI_SSID
#define WIFI_SSID "YOUR_WIFI_SSID"      // Set in config/secrets.h (untracked) or via build_flags
#endif
#ifndef WIFI_PASSWORD
#define WIFI_PASSWORD "YOUR_WIFI_PASSWORD" // Set in config/secrets.h (untracked) or via build_flags
#endif
#ifndef HOSTNAME
